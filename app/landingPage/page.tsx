...
//   // First useEffect for mobile check
//   useEffect(() => {
//     const checkIfMobile = () => {
...
//   // Second useEffect for fetching seller email
//   useEffect(() => {
...
//         const response = await axios.get("http://localhost:8080/api/seller/shop/me", {
//           headers: {
...
//           console.log("Email set to:", response.data.email); // Debug log
//         }
//       } catch (error) {
...
//         className={`
//           ${isMobile ? 
//             `fixed top-0 left-0 h-full z-50 transform ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}` : 
//             'relative'
//           }
...
//       >
//         {/* Logo Area - hidden on mobile as we have the header */}
//         <div className="hidden md:flex items-center justify-center h-16 border-b">
//           {expanded ? (
//             <h1 className="text-xl font-bold text-indigo-600 transition-opacity duration-200">Seller Hub</h1>
//           ) : (
...
//           <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-0">Welcome to your Seller Dashboard</h1>
//           <div className="flex items-center space-x-4">
//             <button className="relative p-2 rounded-full hover:bg-gray-100 transition-colors duration-200">
//               <Bell size={24} className="text-gray-600" />
//               <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-full text-white text-xs flex items-center justify-center transform transition-transform duration-200 hover:scale-110 animate-pulse">3</span>
//             </button>
//           </div>
//         </div>
        
//         {/* Content for First-Time Login */}
...
//           <p className="text-gray-600 mb-4 text-sm md:text-base">Complete these steps to set up your seller account:</p>
...
//                   <p className="text-sm text-gray-500">Your seller account has been successfully created</p>
//                 </div>
//               </div>
//             </div>
...
//                   <p className="text-sm text-gray-500">Start selling by adding your first product</p>
//                 </div>
//               </div>
//               <button
//                   onClick={() => router.push("/product-lisitin")}
...
const SellerLandingPage: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    { icon: <Home size={24} />, label: "Dashboard", id: "dashboard", link: "/" },
    {
    ...
    { icon: <Settings size={24} />, label: "Settings", id: "settings", link: "/settings" },
  ];
